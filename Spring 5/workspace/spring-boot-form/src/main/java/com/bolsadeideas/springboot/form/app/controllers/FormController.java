...
public class FormController {
	...
	public void initBinder(WebDataBinder binder) {
		...
		binder.registerCustomEditor(Date.class, "fechaNacimiento" , new CustomDateEditor(dateFormat, false)); //para campos en particular de tipo Date
