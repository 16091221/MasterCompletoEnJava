...
import org.scesar.poointerfaces.modelo.BaseEntity;
import org.scesar.poointerfaces.repositorio.excepciones.*;
...
public abstract class AbstractaListRepositorio<T extends BaseEntity> implements OrdenablePaginableCrudRepositorio<T> {
    ...
    public void crear(T t) throws EscrituraAccesoDatosException {
        if(t == null){
            throw new EscrituraAccesoDatosException("Error a insertar un objeto null");
        }
